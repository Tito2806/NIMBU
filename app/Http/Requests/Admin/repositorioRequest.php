...
class repositorioRequest extends FormRequest
{
    ...
    public function createRules(): array
    {
        return [
            ...
            'titulo' => 'required|string|min:3|max:255|regex:/^([a-zA-ZñÑáéíóúÁÉÍÓÚ-])+((\s*)+([a-zA-ZñÑáéíóúÁÉÍÓÚ-]*)*)+$/',
    ...
    public function messages(){
        return [
            'autor.regex' => "Solo letras se permiten",
            'autor.*' => "Se requiere un autor",
            'titulo.regex' => "Solo letras se permiten",
