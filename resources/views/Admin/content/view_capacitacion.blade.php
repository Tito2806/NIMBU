            ...
            <div class="modal-body">
                <form id="formCapacitacion" name="formCapacitacion">
                    <div class="form-group">
                        ...
                        <br>
                        <label for="descripcion">Descripción de la capacitación</label>
                        <textarea name="descripcion" id="descripcion" cols="10" rows="5" placeholder="Breve descripción..." class="form-control"></textarea>
                        <div class="errors" id="error_Descripcion">
                        </div>
                        <br>
                        <label for="imagen">Imagen de la Capacitación</label>
        ...
        $('document').ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            return '<img src="../../../../images/Capacitaciones/' + data +
                                '" width="70px">';
                        }
                    },
                    {
            ...
            $('body').on('click', '.editCapacitaciones', function() {
                ...
                $.get("{{ route('capacitacion.index') }}" + '/' + id_capacitacion + '/edit', function(data) {
                    ...
                    image.title = data.imagen;
                        image.src = "../../../../images/Capacitaciones/" + data.imagen;
                        document.getElementById("imagen").value = image.src;
                        preview.appendChild(image);
