...
Route::get('/repositorioNimbuFiltro', [App\Http\Controllers\ClienteController::class, 'repositorioFiltro'])->name('repositorioFiltro');
Route::get('/repositorioNimbuFiltroView', [App\Http\Controllers\ClienteController::class, 'repositorioFiltroView'])->name('repositorioFiltroView');
